---
title: "Country wise topic models (K val adjusted )"
...
##Topic generation for GB (in collaboration) publications

data_collab <- data[data[["GB"]] != 0,]
...
data_independent <- data[data[["GB"]] == 100,]
